# README V8 physical model diagnostics: fluence_0p5_20ps_free_surface_ablation_debug_weaker_heat_v2
...
- Maximum low-density area fraction (`rho/rho0 < 0.7`): `0.26`.
- Maximum void area fraction (`rho/rho0 < 0.3`): `0.0714`.
- Maximum raw max-z lift: `0.664 nm`.
- Maximum robust p95 lift: `0.17 nm`.
- Raw-lift outlier warning: `limited`.
- Maximum detached candidates: `0`.
- Maximum stable ejecta: `0`.
- Maximum pressure p99 after bin conversion: `4.14 GPa`.
- Maximum global lattice/atom temperature from thermo: `915 K`.
- Maximum heated-surface thermal temperature p95: `4.68e+03 K`.
...
- Maximum molten atom fraction by thermal temperature: `0.126`.
- Maximum vapor-reference atom fraction by thermal temperature: `0.0278`.
- Maximum single-atom KE in saved dumps: `3.02 eV`.
- Maximum upward velocity in saved dumps: `34.8 A/ps`.
- Maximum z position relative to the initial surface: `0.664 nm`.
