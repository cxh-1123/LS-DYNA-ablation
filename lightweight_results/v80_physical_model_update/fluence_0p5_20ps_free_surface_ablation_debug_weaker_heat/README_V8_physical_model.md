# README V8 physical model diagnostics: fluence_0p5_20ps_free_surface_ablation_debug_weaker_heat
...
- Maximum low-density area fraction (`rho/rho0 < 0.7`): `0.263`.
- Maximum void area fraction (`rho/rho0 < 0.3`): `0.0694`.
- Maximum raw max-z lift: `3.77 nm`.
- Maximum robust p95 lift: `0.0926 nm`.
- Raw-lift outlier warning: `YES`.
- Maximum detached candidates: `7`.
- Maximum stable ejecta: `1`.
- Maximum pressure p99 after bin conversion: `5.17 GPa`.
- Maximum global lattice/atom temperature from thermo: `1.21e+03 K`.
- Maximum heated-surface thermal temperature p95: `9.06e+03 K`.
...
- Maximum molten atom fraction by thermal temperature: `0.173`.
- Maximum vapor-reference atom fraction by thermal temperature: `0.0581`.
- Maximum single-atom KE in saved dumps: `5.38 eV`.
- Maximum upward velocity in saved dumps: `49.3 A/ps`.
- Maximum z position relative to the initial surface: `3.77 nm`.
